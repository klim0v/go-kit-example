...
import (
	...
	grpc "github.com/klim0v/go-kit-example/adder/pkg/grpc"
	pb "github.com/klim0v/go-kit-example/adder/pkg/grpc/pb"
	http "github.com/klim0v/go-kit-example/adder/pkg/http"
...
var fs = flag.NewFlagSet("adder", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "adder")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterAdderServer(baseServer, grpcServer)
